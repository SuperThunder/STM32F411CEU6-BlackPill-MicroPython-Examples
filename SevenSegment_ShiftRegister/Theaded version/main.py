# USE:
# Copy this file (as main.py), FourDigitSevenSegmentShift_Thread.py, and ShiftRegister.py to your board
...
import FourDigitSevenSegmentShift_Thread

def main():
    print("Shift Register + 4digit7segment with _thread")

    sr = ShiftRegister('PA3', 'PA1', 'PA2', chain=2)
